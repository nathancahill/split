    ...
    var global = this
      ...
      , Split = function (ids, options) {
          ...
          var startDragging = function (e) {
              ...
              //do not drag in collapse mode
              var node = self.gutter.childNodes[0];
              if (node && node.className === "collapsed") {
                  return;
              }
            ...
            collapse = function () {
                ...
                var gutterSize = this.aGutterSize + this.bGutterSize;
                this.b.style[dimension] = calc + '(' + this.percentage + '% - ' + gutterSize + 'px)';

                var child = this.gutter.childNodes[0];
            ...
            expand = function () {
                ...
                var gutterSize = this.aGutterSize + this.bGutterSize;
                this.a.style[dimension] = calc + '(' + this.aDefault + '% - ' + gutterSize + 'px)';
                this.b.style[dimension] = this.bDefault + "%";

                var child = this.gutter.childNodes[0];
                child.className = "expanded";
                child.title = "Collapse";
            }, toggle = function () {
                var action = this.gutter.childNodes[0].className == "collapsed" ? expand : collapse;
                action.call(this);
            }
          ...
          for (i = 0; i < ids.length; i++) {
              ...
              if (i > 0) {
                  ...
                  pair = {
                      ...
                      aDefault: options.sizes[i - 1],
                      bDefault: options.sizes[i],
                      dragging: false,
                      parent: parent,
                      isFirst: isFirst,
                      isLast: isLast,
              ...
              if (!isIE8) {
                  if (i > 0) {
                      ...
                      gutterChild.className = "expanded";
                      gutterChild.title = "Collapse";
                      gutterChild[addEventListener]('click', toggle.bind(pair));
                      gutterChild[addEventListener]('touch', toggle.bind(pair));
