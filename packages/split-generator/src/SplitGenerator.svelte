...
<div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
    ...
    <div class="grid grid-cols-1 gap-4">
        <section aria-labelledby="section-2-title" class="flex flex-col">
            <div
                id="ad_slot"
                class="mb-4 rounded-lg bg-white overflow-hidden shadow order-last lg:order-first"
            >
                <script
                    async
            ...
            <div class="mb-4 rounded-lg bg-white overflow-hidden shadow">
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <Stepper bind:value={panes} default={defaultPanes} />
                    </div>
            ...
            <div class="order-last">
                <a
                    ...
                    class="flex w-full items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium rounded-t-md border-indigo-200 text-indigo-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:z-10"
                >
                    <svg
                        role="img"
                        viewBox="0 0 26 24"
